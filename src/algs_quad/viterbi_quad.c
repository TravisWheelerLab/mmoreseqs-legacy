                   ...
                   float*             sc_final)
{
   ...
   for (i = 1; i <= Q; i++)
   {
      ...
      for (j = 1; j < T; j++)
      {
         ...
         sc1 = XMX_M(SP_E, i);
         sc2 = MMX_M(i, j) + sc_E;
         sc4 = XMX_M(SP_E, i) = calc_Max( XMX_M(SP_E, i), MMX_M(i, j) + sc_E );
      }
      ...
      sc2 = MMX_M(i, j);
      sc3 = DMX_M(i, j);
      sc4 = XMX_M(SP_E, i) = calc_Max( sc1, calc_Max( sc2, sc3 ) );
      ...
      XMX_M(SP_B, i) = calc_Max( sc_1, sc_2 );
   }
