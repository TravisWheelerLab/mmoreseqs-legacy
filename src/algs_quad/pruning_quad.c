...
inline void
prune_via_xdrop_edgetrim_Quad(MATRIX_3D* st_MX,      /* normal state matrix */
...
inline void
prune_via_xdrop_bifurcate_Quad(MATRIX_3D* st_MX,      /* normal state matrix */
                               MATRIX_2D* sp_MX,      /* special state matrix */
                               const float alpha,     /* x-drop value */
                               const int gamma,       /* number of antidiagonals before pruning */
                               const int d_1,         /* previous antidiagonal */
...
inline void
prune_diag_by_xdrop_edgetrim_or_die_Quad(MATRIX_3D* st_MX,      /* normal state matrix */
                                         MATRIX_2D* sp_MX,      /* special state matrix */
