 ...
 *  - DESC:    Functions for handling errors.
 *******************************************************************************/
 ...
 *             Handles the error messaging, with program location, and closes
 * program.
 */
FILE* ERRORCHECK_fopen(const char* filename,
 ...
 */
FILE* ERRORCHECK_fclose(FILE* fp,
                        const char* _file_,
                        const int _line_,
                        const char* _func_);
 ...
 *             If memory error causes a NULL pointer to be returned, then memory
 * error is thrown. Handles the error messaging, with program location, and
 * closes program.
 */
 ...
 */
void ERRORCHECK_memcheck(int row, int col, float mat, float ins, float del);
