 ...
 */
void DP_MATRIX_GetBounds(const int Q,
                         const int T,
                         int d_0,
                         int d_cnt,
                         BOUND* bnd);
 ...
 */
void DP_MATRIX_VIZ_Save(MATRIX_2D* cloud_MX, char* filename);

/*! FUNCTION:  DP_MATRIX_VIZ_Dump()
 *  SYNOPSIS:  Outputs simple visualization of dp matrix.
 */
void DP_MATRIX_VIZ_Dump(MATRIX_2D* test_MX, FILE* fp);

/*! FUNCTION:  DP_MATRIX_VIZ_Dump()
 *  SYNOPSIS:  Outputs simple visualization of dp matrix.
 *             Symbols are color-coded.
 */
void DP_MATRIX_VIZ_Color_Dump(MATRIX_2D* cloud_MX, FILE* fp);

/*! FUNCTION:  DP_MATRIX_VIZ_Trace()
 *  SYNOPSIS:  Adds trace to visulization of dp matrix.
 */
void DP_MATRIX_VIZ_Trace(MATRIX_2D* cloud_MX, const ALIGNMENT* aln);

/*! FUNCTION:  DP_MATRIX_MAT_Dump()
 *  SYNOPSIS:  Outputs match state of matrix.
 */
void DP_MATRIX_MAT_Dump(int Q, int T, MATRIX_3D* st_MX, FILE* fp);
 ...
 *            Sums over matrix.
 */
int EDGEBOUNDS_BruteCount(EDGEBOUNDS* edg);
