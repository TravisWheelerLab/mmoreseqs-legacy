 ...
 */
inline XXX XXX_Create(const XXX data) {
  return data;
}
 ...
 */
inline XXX XXX_Destroy(XXX data) {
  return data;
}
 ...
 */
inline char* XXX_ToString(const XXX data,
                          char* buf) {
  sprintf(buf, "%d", data);
  return buf;
}
 ...
 *    RETURN:  Pointer to <buf>
 */
inline XXX XXX_FromString(char* str) {
  XXX data;
  data = atoi(str);
  return data;
}
 ...
 *             NEGATIVE if (a < b)
 */
inline int XXX_Compare(const XXX a,
                       const XXX b) {
  return (a - b);
}
 ...
 *             NEGATIVE if (a < b)
 */
inline int XXX_CompareTo(const void* a,
                         const void* b) {
  XXX* x = (XXX*)a;
  XXX* y = (XXX*)b;
 ...
 */
inline bool XXX_Equals(const XXX a,
                       const XXX b) {
  bool is_equal;
  is_equal = (XXX_Compare(a, b) == 0);
  return is_equal;
}
