 ...
 */
READER* READER_Destroy(READER* reader);
 ...
 */
STATUS_FLAG
READER_JumpTo(READER* reader, long int offset);
 ...
 */
STATUS_FLAG
READER_SetDelimiter(READER* reader, STR new_delimiter);

/*!  FUNCTION:  READER_SplitLine()
 *   SYNOPSIS:  Split <reader>'s <line> by <delim> and load into
 * <field_offsets>. RETURN:    Returns number of line splits / fields.
 */
size_t READER_SplitLine(READER* reader);
 ...
 */
STR READER_GetField(READER* reader, size_t i);
