 ...
 */
void SEQUENCE_SetSeq(SEQUENCE* seq,
                     char* seq_text) {
  /* old sequence type */
 ...
 *  RETURN:    Returns <STATUS_SUCCESS> if no errors.
 */
void SEQUENCE_AppendSeq(SEQUENCE* seq,
                        char* seq_text) {
  if (seq_text == NULL)
    return;
 ...
 *  RETURN:    Returns <STATUS_SUCCESS> if no errors.
 */
void SEQUENCE_Resize(SEQUENCE* seq,
                     int size) {
  /* old sequence type */
  seq->Nalloc = size;
 ...
 */
char SEQUENCE_GetCharAt(const SEQUENCE* seq,
                        const int i) {
  char c;
 ...
 */
int SEQUENCE_GetDigitAt(const SEQUENCE* seq,
                        const int i) {
  char val;
 ...
 *  RETURN:    Returns <STATUS_SUCCESS> if no errors.
 */
void SEQUENCE_SetTextfield(STR* seq_field,
                           STR text) {
 ...
 *  RETURN:    Returns <STATUS_SUCCESS> if no errors.
 */
void SEQUENCE_SetDomain(SEQUENCE* seq,
                        RANGE Q_range) {
