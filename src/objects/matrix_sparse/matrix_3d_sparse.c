 ...
 */
FLT* MATRIX_3D_SPARSE_GetX_by1D(const MATRIX_3D_SPARSE* smx, /* MATRIX_3D_SPARSE object */
 ...
 *             Returns NULL if out-of-bounds of sparse matrix.
 */
FLT* MATRIX_3D_SPARSE_GetX_byOffset(const MATRIX_3D_SPARSE* smx, /* MATRIX_3D_SPARSE object */
 ...
 */
float MATRIX_3D_SPARSE_Get(const MATRIX_3D_SPARSE* smx, /* MATRIX_3D_SPARSE object */
 ...
 */
int MATRIX_3D_SPARSE_GetNumberBounds(const MATRIX_3D_SPARSE* smx) {
  int num_bounds;
 ...
 */
int MATRIX_3D_SPARSE_GetNumberBounds_byRow(const MATRIX_3D_SPARSE* smx,
 ...
 */
MATRIX_3D*
MATRIX_3D_SPARSE_Exp_Embed(int Q,
                           int T,
                           MATRIX_3D_SPARSE* smx, /* sparse matrix */
                           MATRIX_3D* mx)         /* matrix */
{
  ...
  for (int r_0 = r_0b; r_0 < r_0e; r_0++) {
    ...
    for (t_0 = lb_0; t_0 < rb_0; t_0++) {
      ...
      /* embed linear row into quadratic test matrix */
      MX_3D(mx, MAT_ST, q_0, t_0) = expf(SMX_X(smx, MAT_ST, qx0, tx0));
      MX_3D(mx, INS_ST, q_0, t_0) = expf(SMX_X(smx, INS_ST, qx0, tx0));
      MX_3D(mx, DEL_ST, q_0, t_0) = expf(SMX_X(smx, DEL_ST, qx0, tx0));
    }
  }
}
 ...
 */
void MATRIX_3D_SPARSE_Op(MATRIX_3D_SPARSE* mx_out, /* input sparse matrix */
 ...
 *             <mx_in> and <mx_out> can be the same matrix.
 */
void MATRIX_3D_SPARSE_BinOp(MATRIX_3D_SPARSE* mx_out,          /* input sparse matrix */
 ...
 */
void MATRIX_3D_SPARSE_Iter_Reset(MATRIX_3D_SPARSE* smx) /* sparse matrix */
{
  smx->r_0 = (RANGE){0, 0};
  smx->q_0 = 0;
  smx->t_0 = 0;
 ...
 */
int MATRIX_3D_SPARSE_Add(MATRIX_3D_SPARSE* smx_A,   /* IN: addent matrix */
