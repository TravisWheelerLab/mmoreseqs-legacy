 ...
 */
double CLOCK_Duration(CLOCK* cl);

/*! FUNCTION:  CLOCK_GetDiff()
 *  SYNOPSIS:  Get time <duration> between <start> and <stop>, acquired from
 * CLOCK_GetTime(). RETURN:    Duration time.
 */
double CLOCK_GetDiff(CLOCK* cl, double start, double stop);

/*! FUNCTION:  CLOCK_GetTime()
 *  SYNOPSIS:  Get current time.
 *  RETURN:    Current time.
 */
double CLOCK_GetTime(CLOCK* cl);

/*! FUNCTION:  CLOCK_GetMyTime()
 *  SYNOPSIS:  Get current time (using my simple method)
 *  RETURN:    Current time.
 */
double CLOCK_GetMyTime();

/*! FUNCTION:  CLOCK_GetEaselTime()
 *  SYNOPSIS:  Capture time based on system (using easel method)
 *  RETURN:    Current time.
 */
double CLOCK_GetEaselTime();
