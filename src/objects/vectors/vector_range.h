/*******************************************************************************
 *  - FILE:   vector_range.c
 *  - DESC:    VECTOR_RANGE Object Functions
 *******************************************************************************/
 ...
 *  SYNOPSIS:  Allocates new VECTOR_RANGE object at specific size and returns
 * pointer.
 */
VECTOR_RANGE* VECTOR_RANGE_Create_by_Size(size_t size);

/*! FUNCTION:  VECTOR_RANGE_Destroy()
 *  SYNOPSIS:  Frees all data associated with VECTOR_RANGE and returns NULL
 * pointer.
 */
VECTOR_RANGE* VECTOR_RANGE_Destroy(VECTOR_RANGE* vec);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_GrowTo(VECTOR_RANGE* vec, size_t size);
 ...
 */
RANGE
VECTOR_RANGE_Get(VECTOR_RANGE* vec, int idx);
 ...
 */
RANGE* VECTOR_RANGE_GetX(VECTOR_RANGE* vec, int idx);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Set(VECTOR_RANGE* vec, int idx, RANGE val);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Insert(VECTOR_RANGE* vec, int idx, RANGE val);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Delete(VECTOR_RANGE* vec, int idx);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Push(VECTOR_RANGE* vec, RANGE val);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Pushback(VECTOR_RANGE* vec, RANGE val);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Append(VECTOR_RANGE* vec, RANGE* append, size_t L);

/*! FUNCTION:  VECTOR_RANGE_GetSize()
 *  SYNOPSIS:  Get utilized length of <vec>.
 */
int VECTOR_RANGE_GetSize(VECTOR_RANGE* vec);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_SetSize(VECTOR_RANGE* vec, size_t size);

/*! FUNCTION:  VECTOR_RANGE_GetSizeAlloc()
 *  SYNOPSIS:  Get allocated length of <vec>.
 */
int VECTOR_RANGE_GetSizeAlloc(VECTOR_RANGE* vec);
 ...
 */
int VECTOR_RANGE_Search(VECTOR_RANGE* vec, RANGE val);
 ...
 *             Return -1 if <val> is not found.
 */
int VECTOR_RANGE_Search_First(VECTOR_RANGE* vec, RANGE val);
 ...
 *             Return -1 if <val> is not found.
 */
int VECTOR_RANGE_Search_Last(VECTOR_RANGE* vec, RANGE val);
 ...
 *             neg if <vec_A> < <vec_B>.
 */
int VECTOR_RANGE_Compare(VECTOR_RANGE* vec_A, VECTOR_RANGE* vec_B);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Sort_Sub(VECTOR_RANGE* vec, int beg, int end);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Sort_Sub_Selectsort(VECTOR_RANGE* vec, int beg, int end);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Sort_Sub_Quicksort(VECTOR_RANGE* vec, int beg, int end);

/*! FUNCTION:  VECTOR_RANGE_Op()
 *  SYNOPSIS:  Perform element-wise unary operation <op>(RANGE data) to each
 ...
 */
VECTOR_RANGE* VECTOR_RANGE_Op(
    VECTOR_RANGE* vec_out,    /* input vector */
    VECTOR_RANGE* vec_in,     /* output vector (can be input vector) */
    RANGE (*op)(RANGE data)); /* unary operation function */

/*! FUNCTION:  VECTOR_RANGE_Op()
 *  SYNOPSIS:  Perform element-wise binary operation <op>(RANGE data_1, RANGE
 ...
 * NULL, new vector will be created.
 */
VECTOR_RANGE* VECTOR_RANGE_BinOp(
    VECTOR_RANGE* vec_out,                    /* output vector */
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Swap(VECTOR_RANGE* vec, int i, int j);
 ...
 */
STATUS_FLAG
VECTOR_RANGE_Dump(VECTOR_RANGE* vec, FILE* fp);

/*! FUNCTION:  VECTOR_RANGE_Dump_byOpt()
 *  SYNOPSIS:  Output <vec> to <fp> file pointer. Non-optimized.
 */
STATUS_FLAG
VECTOR_RANGE_Dump_byOpt(VECTOR_RANGE* vec, STR delim, STR header, FILE* fp);
