 ...
 *  SYNOPSIS:  Allocates new VECTOR_PTR object at specific size and returns pointer.
 */
VECTOR_PTR* 
VECTOR_PTR_Create_by_Size( size_t    size );

/*! FUNCTION:  VECTOR_PTR_Destroy()
 *  SYNOPSIS:  Frees all data associated with VECTOR_PTR and returns NULL pointer.
 */
VECTOR_PTR* 
 ...
 *  SYNOPSIS:  Perform element-wise unary operation <op>(PTR data) to each cell in <vec_in> and puts it in <vec_out>.
