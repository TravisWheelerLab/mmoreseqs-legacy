 ...
 */
VECTOR_STR* VECTOR_STR_Create();

/*! FUNCTION:  VECTOR_STR_Create_by_Size()
 *  SYNOPSIS:  Allocates new VECTOR_STR object at specific size and returns
 * pointer.
 */
VECTOR_STR* VECTOR_STR_Create_by_Size(size_t size);

/*! FUNCTION:  VECTOR_STR_Destroy()
 *  SYNOPSIS:  Frees all data associated with VECTOR_STR and returns NULL
 * pointer.
 */
VECTOR_STR* VECTOR_STR_Destroy(VECTOR_STR* vec);
 ...
 */
STATUS_FLAG
VECTOR_STR_GrowTo(VECTOR_STR* vec, size_t size);
 ...
 */
STR VECTOR_STR_Get(VECTOR_STR* vec, int idx);
 ...
 */
STR* VECTOR_STR_GetX(VECTOR_STR* vec, int idx);
 ...
 */
STATUS_FLAG
VECTOR_STR_Set(VECTOR_STR* vec, int idx, STR val);
 ...
 */
STATUS_FLAG
VECTOR_STR_Insert(VECTOR_STR* vec, int idx, STR val);
 ...
 */
STATUS_FLAG
VECTOR_STR_Delete(VECTOR_STR* vec, int idx);
 ...
 */
STATUS_FLAG
VECTOR_STR_Push(VECTOR_STR* vec, STR val);
 ...
 */
STATUS_FLAG
VECTOR_STR_Append(VECTOR_STR* vec, STR* append, size_t L);

/*! FUNCTION:  VECTOR_STR_GetSize()
 *  SYNOPSIS:  Get utilized length of <vec>.
 */
int VECTOR_STR_GetSize(VECTOR_STR* vec);
 ...
 */
STATUS_FLAG
VECTOR_STR_SetSize(VECTOR_STR* vec, size_t size);

/*! FUNCTION:  VECTOR_STR_GetSizeAlloc()
 *  SYNOPSIS:  Get allocated length of <vec>.
 */
int VECTOR_STR_GetSizeAlloc(VECTOR_STR* vec);
 ...
 */
int VECTOR_STR_Search(VECTOR_STR* vec, STR val);
 ...
 *             Return -1 if <val> is not found.
 */
int VECTOR_STR_Search_First(VECTOR_STR* vec, STR val);
 ...
 *             Return -1 if <val> is not found.
 */
int VECTOR_STR_Search_Last(VECTOR_STR* vec, STR val);
 ...
 *             neg if <vec_A> < <vec_B>.
 */
int VECTOR_STR_Compare(VECTOR_STR* vec_A, VECTOR_STR* vec_B);
 ...
 */
STATUS_FLAG
VECTOR_STR_Sort_Sub(VECTOR_STR* vec, int beg, int end);
 ...
 */
STATUS_FLAG
VECTOR_STR_Sort_Sub_Selectsort(VECTOR_STR* vec, int beg, int end);
 ...
 */
STATUS_FLAG
VECTOR_STR_Sort_Sub_Quicksort(VECTOR_STR* vec, int beg, int end);

/*! FUNCTION:  VECTOR_STR_Op()
 *  SYNOPSIS:  Perform element-wise unary operation <op>(STR data) to each cell
 ...
 */
VECTOR_STR* VECTOR_STR_Op(
    VECTOR_STR* vec_out,  /* input vector */
    VECTOR_STR* vec_in,   /* output vector (can be input vector) */
    STR (*op)(STR data)); /* unary operation function */

/*! FUNCTION:  VECTOR_STR_Op()
 *  SYNOPSIS:  Perform element-wise binary operation <op>(STR data_1, STR
 ...
 * NULL, new vector will be created.
 */
VECTOR_STR* VECTOR_STR_BinOp(
    VECTOR_STR* vec_out,                /* output vector */
 ...
 */
STATUS_FLAG
VECTOR_STR_Swap(VECTOR_STR* vec, int i, int j);
 ...
 */
STATUS_FLAG
VECTOR_STR_Dump(VECTOR_STR* vec, FILE* fp);

/*! FUNCTION:  VECTOR_STR_Dump_byOpt()
 *  SYNOPSIS:  Output <vec> to <fp> file pointer. Non-optimized.
 */
STATUS_FLAG
VECTOR_STR_Dump_byOpt(VECTOR_STR* vec, STR delim, STR header, FILE* fp);
