/*******************************************************************************
 *  - FILE:   vector_char.c
 *  - DESC:    VECTOR_CHAR Object Functions
 *******************************************************************************/
 ...
 *  SYNOPSIS:  Allocates new VECTOR_CHAR object at specific size and returns
 * pointer.
 */
VECTOR_CHAR* VECTOR_CHAR_Create_by_Size(size_t size);

/*! FUNCTION:  VECTOR_CHAR_Destroy()
 *  SYNOPSIS:  Frees all data associated with VECTOR_CHAR and returns NULL
 * pointer.
 */
VECTOR_CHAR* VECTOR_CHAR_Destroy(VECTOR_CHAR* vec);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_GrowTo(VECTOR_CHAR* vec, size_t size);
 ...
 */
CHAR VECTOR_CHAR_Get(VECTOR_CHAR* vec, int idx);
 ...
 */
CHAR* VECTOR_CHAR_GetX(VECTOR_CHAR* vec, int idx);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Set(VECTOR_CHAR* vec, int idx, CHAR val);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Insert(VECTOR_CHAR* vec, int idx, CHAR val);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Delete(VECTOR_CHAR* vec, int idx);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Push(VECTOR_CHAR* vec, CHAR val);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Pushback(VECTOR_CHAR* vec, CHAR val);
 ...
 */
CHAR VECTOR_CHAR_Popback(VECTOR_CHAR* vec);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Append(VECTOR_CHAR* vec, CHAR* append, size_t L);

/*! FUNCTION:  VECTOR_CHAR_GetSize()
 *  SYNOPSIS:  Get utilized length of <vec>.
 */
int VECTOR_CHAR_GetSize(VECTOR_CHAR* vec);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_SetSize(VECTOR_CHAR* vec, size_t size);

/*! FUNCTION:  VECTOR_CHAR_GetSizeAlloc()
 *  SYNOPSIS:  Get allocated length of <vec>.
 */
int VECTOR_CHAR_GetSizeAlloc(VECTOR_CHAR* vec);
 ...
 */
int VECTOR_CHAR_Search(VECTOR_CHAR* vec, CHAR val);
 ...
 *             Return -1 if <val> is not found.
 */
int VECTOR_CHAR_Search_First(VECTOR_CHAR* vec, CHAR val);
 ...
 *             Return -1 if <val> is not found.
 */
int VECTOR_CHAR_Search_Last(VECTOR_CHAR* vec, CHAR val);
 ...
 *             neg if <vec_A> < <vec_B>.
 */
int VECTOR_CHAR_Compare(VECTOR_CHAR* vec_A, VECTOR_CHAR* vec_B);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Sort_Sub(VECTOR_CHAR* vec, int beg, int end);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Sort_Sub_Selectsort(VECTOR_CHAR* vec, int beg, int end);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Sort_Sub_Quicksort(VECTOR_CHAR* vec, int beg, int end);

/*! FUNCTION:  VECTOR_CHAR_Op()
 *  SYNOPSIS:  Perform element-wise unary operation <op>(CHAR data) to each cell
 ...
 */
VECTOR_CHAR* VECTOR_CHAR_Op(
    VECTOR_CHAR* vec_out,   /* input vector */
    VECTOR_CHAR* vec_in,    /* output vector (can be input vector) */
    CHAR (*op)(CHAR data)); /* unary operation function */

/*! FUNCTION:  VECTOR_CHAR_Op()
 *  SYNOPSIS:  Perform element-wise binary operation <op>(CHAR data_1, CHAR
 ...
 * NULL, new vector will be created.
 */
VECTOR_CHAR* VECTOR_CHAR_BinOp(
    VECTOR_CHAR* vec_out,                  /* output vector */
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Swap(VECTOR_CHAR* vec, int i, int j);
 ...
 */
STATUS_FLAG
VECTOR_CHAR_Dump(VECTOR_CHAR* vec, FILE* fp);

/*! FUNCTION:  VECTOR_CHAR_Dump_byOpt()
 *  SYNOPSIS:  Output <vec> to <fp> file pointer. Non-optimized.
 */
STATUS_FLAG
VECTOR_CHAR_Dump_byOpt(VECTOR_CHAR* vec, STR delim, STR header, FILE* fp);
