 ...
 *  SYNOPSIS:  Frees all data associated with VECTOR_INT and returns NULL pointer.
 */
VECTOR_INT* 
 ...
 *  SYNOPSIS:  Perform element-wise unary operation <op>(INT data) to each cell in <vec_in> and puts it in <vec_out>.
