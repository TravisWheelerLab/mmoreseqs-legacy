/*******************************************************************************
 *  - FILE:      vector_bound.c
 *  - DESC:    VECTOR_BOUND Object Functions
 *******************************************************************************/
 ...
 *  SYNOPSIS:  Allocates new VECTOR_BOUND object at specific size and returns
 * pointer.
 */
VECTOR_BOUND* VECTOR_BOUND_Create_by_Size(size_t size);

/*! FUNCTION:  VECTOR_BOUND_Destroy()
 *  SYNOPSIS:  Frees all data associated with VECTOR_BOUND and returns NULL
 * pointer.
 */
VECTOR_BOUND* VECTOR_BOUND_Destroy(VECTOR_BOUND* vec);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_GrowTo(VECTOR_BOUND* vec, size_t size);
 ...
 */
BOUND
VECTOR_BOUND_Get(VECTOR_BOUND* vec, int idx);
 ...
 */
BOUND* VECTOR_BOUND_GetX(VECTOR_BOUND* vec, int idx);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Set(VECTOR_BOUND* vec, int idx, BOUND val);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Insert(VECTOR_BOUND* vec, int idx, BOUND val);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Delete(VECTOR_BOUND* vec, int idx);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Push(VECTOR_BOUND* vec, BOUND val);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Pushback(VECTOR_BOUND* vec, BOUND val);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Append(VECTOR_BOUND* vec, BOUND* append, size_t L);

/*! FUNCTION:  VECTOR_BOUND_GetSize()
 *  SYNOPSIS:  Get utilized length of <vec>.
 */
int VECTOR_BOUND_GetSize(VECTOR_BOUND* vec);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_SetSize(VECTOR_BOUND* vec, size_t size);

/*! FUNCTION:  VECTOR_BOUND_GetSizeAlloc()
 *  SYNOPSIS:  Get allocated length of <vec>.
 */
int VECTOR_BOUND_GetSizeAlloc(VECTOR_BOUND* vec);
 ...
 */
int VECTOR_BOUND_Search(VECTOR_BOUND* vec, BOUND val);
 ...
 *             Return -1 if <val> is not found.
 */
int VECTOR_BOUND_Search_First(VECTOR_BOUND* vec, BOUND val);
 ...
 *             Return -1 if <val> is not found.
 */
int VECTOR_BOUND_Search_Last(VECTOR_BOUND* vec, BOUND val);
 ...
 *             neg if <vec_A> < <vec_B>.
 */
int VECTOR_BOUND_Compare(VECTOR_BOUND* vec_A, VECTOR_BOUND* vec_B);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Sort_Sub(VECTOR_BOUND* vec, int beg, int end);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Sort_Sub_Selectsort(VECTOR_BOUND* vec, int beg, int end);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Sort_Sub_Quicksort(VECTOR_BOUND* vec, int beg, int end);

/*! FUNCTION:  VECTOR_BOUND_Op()
 *  SYNOPSIS:  Perform element-wise unary operation <op>(BOUND data) to each
 ...
 */
VECTOR_BOUND* VECTOR_BOUND_Op(
    VECTOR_BOUND* vec_out,    /* input vector */
    VECTOR_BOUND* vec_in,     /* output vector (can be input vector) */
    BOUND (*op)(BOUND data)); /* unary operation function */

/*! FUNCTION:  VECTOR_BOUND_Op()
 *  SYNOPSIS:  Perform element-wise binary operation <op>(BOUND data_1, BOUND
 ...
 * NULL, new vector will be created.
 */
VECTOR_BOUND* VECTOR_BOUND_BinOp(
    VECTOR_BOUND* vec_out,                    /* output vector */
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Swap(VECTOR_BOUND* vec, int i, int j);
 ...
 */
STATUS_FLAG
VECTOR_BOUND_Dump(VECTOR_BOUND* vec, FILE* fp);

/*! FUNCTION:  VECTOR_BOUND_Dump_byOpt()
 *  SYNOPSIS:  Output <vec> to <fp> file pointer. Non-optimized.
 */
STATUS_FLAG
VECTOR_BOUND_Dump_byOpt(VECTOR_BOUND* vec, STR delim, STR header, FILE* fp);
