 ...
 */
void M8_RESULTS_Pushback(M8_RESULTS* results,
                         M8_RESULT* res) {
 ...
 */
void M8_RESULTS_Resize(M8_RESULTS* results,
                       size_t size) {
  results->Nalloc = size;
 ...
 */
void M8_RESULTS_Dump(M8_RESULTS* results,
                     FILE* fp) {
  if (fp == NULL) {
 ...
 *  SYNOPSIS:  Output single <result> to file <fp>.
 */
void M8_RESULT_Dump_old(M8_RESULT* res,
                        FILE* fp) {
  fprintf(fp, "{ ");
