...
mmoreseqs_easysearch_pipeline(WORKER* worker) {
  printf("=== MMORESEQS: EASYSEARCH PIPELINE ===\n");
  ...
  STR script_relpath = "/scripts/workflows/mmoreseqs-easy-search.sh";
  // STR script_relpath   = "/scripts/workflows/test-workflow.sh";
