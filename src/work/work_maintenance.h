 ...
 *functions. Initialization and Cleanup.
 *******************************************************************************/
...
/*! FUNCTION:  	WORK_init()
 *  SYNOPSIS:  	Initialize <worker> parts that are not handled by
 * WORKER_Create(). Allocate data structs according to settings in its <args>
 * and <tasks>.
 */
