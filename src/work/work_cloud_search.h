 ...
 *  SYNOPSIS:  	Run linear-space "cloud search" step of pruned forward/backward
 ...
 *  SYNOPSIS:  	Run quadratic-space "cloud search" step of pruned
 * forward/backward (aka adaptive-band forward/backward). Depends on <task>
 * settings in <worker>.
 */
void WORK_cloud_search_quadratic(WORKER* worker);
