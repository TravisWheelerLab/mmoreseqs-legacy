...
void WORK_bound_fwdback_linear(WORKER* worker) {
  ...
  if (tasks->lin_bound_fwd) {
...
#if DEBUG
    {
      ...
      DP_MATRIX_Save(Q, T, debugger->test_MX, sp_MX, DEBUG_FOLDER "/my.bound_fwd.lin.000.mx");
      // DP_MATRIX_Trace_Save(Q, T, debugger->test_MX, sp_MX_fwd, tr, DEBUG_FOLDER "/my.bound_fwd.lin.viz.000.mx");
    }
#endif
  }
  ...
  if (tasks->lin_bound_bck) {
...
#if DEBUG
    {
      ...
      DP_MATRIX_Save(Q, T, debugger->test_MX, sp_MX_bck, DEBUG_FOLDER "/my.bound_bck.lin.000.mx");
      // DP_MATRIX_Trace_Save(Q, T, debugger->test_MX, sp_MX, tr, DEBUG_FOLDER "/my.bound_bck.lin.viz.000.mx");
    }
#endif
  }
  /* get threshold score */
...
void WORK_bound_fwdback_sparse(WORKER* worker) {
  ...
  if (tasks->sparse_bound_fwd) {
...
#if DEBUG
    {
      ...
      DP_MATRIX_Save(Q, T, debugger->test_MX, sp_MX_fwd, DEBUG_FOLDER "/my.forward.sp.000.mx");
    }
#endif
  }
  ...
  if (tasks->sparse_bound_bck) {
...
#if DEBUG
    {
      ...
      DP_MATRIX_Save(Q, T, debugger->test_MX, sp_MX_bck, DEBUG_FOLDER "/my.backward.sp.000.mx");
    }
#endif
  }
