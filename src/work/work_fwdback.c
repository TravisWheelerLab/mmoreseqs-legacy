...
void WORK_forward_backward(WORKER* worker) {
  ...
  if (tasks->lin_fwd) {
...
#if DEBUG
    {
      ...
      DP_MATRIX_Save(Q, T, debugger->test_MX, worker->sp_MX_fwd, DEBUG_FOLDER "/my.fwd.lin.000.mx");
      DP_MATRIX_Trace_Save(Q, T, debugger->test_MX, worker->sp_MX_fwd, tr, DEBUG_FOLDER "/my.fwd.lin.viz.000.mx");
    }
#endif
  }
  if (tasks->quad_fwd) {
...
#if DEBUG
    {
      ...
      DP_MATRIX_Save(Q, T, debugger->test_MX, worker->sp_MX_fwd, DEBUG_FOLDER "/my.fwd.quad.000.mx");
    }
#endif
  }
  ...
  if (tasks->lin_bck) {
...
#if DEBUG
    {
      ...
      DP_MATRIX_Save(Q, T, debugger->test_MX, worker->sp_MX_bck, DEBUG_FOLDER "/my.bck.lin.000.mx");
      DP_MATRIX_Trace_Save(Q, T, debugger->test_MX, worker->sp_MX_bck, tr, DEBUG_FOLDER "/my.bck.lin.viz.000.mx");
    }
#endif
  }
  if (tasks->quad_bck) {
...
#if DEBUG
    {
      ...
      DP_MATRIX_Save(Q, T, debugger->test_MX, worker->sp_MX_bck, DEBUG_FOLDER "/my.bck.quad.000.mx");
    }
#endif
  }
}
