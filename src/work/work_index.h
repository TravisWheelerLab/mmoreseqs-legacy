 ...
 *functions. Build, load and retrieve file indexes.
 *******************************************************************************/
 ...
 *  SYNOPSIS:  	Load or build target and query index files <t_index> for
 * <q_index>. Stored in <worker>.
 */
 ...
 *  SYNOPSIS:  	Load or build target index <t_index> and query index <q_index>
 * for <worker>. Then sorts index by name.
 */
