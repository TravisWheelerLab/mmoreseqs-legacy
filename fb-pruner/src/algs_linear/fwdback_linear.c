                        ...
                        float*             sc_final )
{
   ...
   MMX3(r_0, c_0) = DMX3(r_0, c_0) = XMX(SP_E, x_0);
   IMX3(r_0, c_0) = -INF;
   ...
   for (i = Q-1; i >= 1; i--)
   {
      ...
      for (j = 2; j <= T; j++) {
         ...
         prev_mat = MMX3(r_1, c_0) + TSC(c_1, B2M) + MSC(c_0, A);
      ...
      for (j = T-1; j >= 1; j--)
      {
         ...
         prev_mat = MMX3(r_1, c_1) + TSC(c_0, M2M) + MSC(c_1, A);
         prev_ins = IMX3(r_1, c_0) + TSC(c_0, M2I) + ISC(c_1, A);
         prev_del = DMX3(r_0, c_1) + TSC(c_0, M2D);
         ...
         prev_mat = MMX3(r_1, c_1) + TSC(c_0, I2M) + MSC(c_1, A);
         prev_ins = IMX3(r_1, c_0) + TSC(c_0, I2I) + ISC(c_0, A);
         /* best-to-insert */
         prev_sum = logsum( prev_mat, prev_ins );
         IMX3(r_0, c_0) = prev_sum;

         /* FIND SUM OF PATHS FROM MATCH OR DELETE STATE (FROM PREVIOUS DELETE) */
         prev_mat = MMX3(r_1, c_1) + TSC(c_0, D2M) + MSC(c_1, A);
         prev_del = DMX3(r_0, c_1) + TSC(c_0, D2D);
   ...
   for (j = 2; j <= T; j++) {
      ...
      c_1 = j-1;
      prev_sum = XMX(SP_B, x_0);
      prev_mat = MMX3(x_1, c_0) + TSC(c_1, B2M) + MSC(c_0, A);
      XMX(SP_B, x_0) = logsum( prev_sum, prev_mat );
   }
