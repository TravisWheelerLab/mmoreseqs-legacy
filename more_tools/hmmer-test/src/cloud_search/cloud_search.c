                           ...
                           float              *sc_final )
{
   ...
   /* TODO: should ensure that matrices are cleared at the end of each use */
                              ...
                              float              *sc_final )
{
   ...
   for (x_0 = Q-1; x_0 > 0; x_0--)
   {
      ...
      // printf("START x_0: %d, x_1: %d, r_0: %d, r_1: %d, => (%d,%d)\n", x_0, x_1, r_0, r_1, r_0b, r_0e);
      ...
      for (i = r_0b; i > r_0e; i--)
      {
         ...
         // printf("x_0: %d, x_1: %d, r_0: %d, r_1: %d => y1: %d, y2: %d \n", x_0, x_1, r_0, r_1, y1, y2);
