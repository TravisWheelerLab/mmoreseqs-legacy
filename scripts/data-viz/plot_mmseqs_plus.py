...
# set headers
mmseqs_header = ["result_id", "target_id", "query_id", "target_length", "query_length", "total_cells", "cloud_cells", "alpha", "beta", "viterbi_score", "forward_score", "backward_score",
                 "cloud_score", "viterbi_time", "forward_time", "backward_time", "cloud_forward_time", "cloud_backward_time", "merge_time", "reorient_time", "bound_forward_time", "total_time"]
hmmer_header = ["result_id", "target_id", "query_id", "target_length", "target_name",
                "query_length", "query_name", "forward_time", "forward_score", "backward_score"]

# load data
mmseqs_data = pd.read_csv(mmseqs_fname, sep="\t", header=None, skiprows=[
                          0], names=mmseqs_header, index_col=False, verbose=True)
hmmer_data = pd.read_csv(hmmer_fname, sep=" ", header=None, skiprows=[
                         174085, 174086], names=hmmer_header, verbose=True)
