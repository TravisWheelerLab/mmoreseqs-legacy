...
function PREP_PREPARE
{
	...
	END_TIME_PREPARE=$(GET_TIME)
	TIME_PREP=$(GET_DURATION $BEG_TIME_PREPARE $END_TIME_PREPARE)
	printf "# TIME_PREP_PREPARE: %.3f sec\n" $TIME_PREP
}

# select pipeline 
echo "# Selecting Pipeline..."
