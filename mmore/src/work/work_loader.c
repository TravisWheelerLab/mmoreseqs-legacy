 ...
 */
void 
WORK_load_mmseqs_file( WORKER* worker )
{
   ARGS*    args     = worker->args;
 ...
 */
void 
WORK_load_mmseqs_by_id( WORKER*  worker,
                        int      id )
{
   ARGS*       args        = worker->args;
   RESULT*     result      = worker->result;
 ...
 */
void 
WORK_load_mmseqs_alignment( WORKER*  worker )
{
   ARGS*          args     = worker->args;
 ...
 */
void 
WORK_load_target_by_findex_id(   WORKER*     worker,
                                 int         index_id )
{
   ARGS*          args     = worker->args;
   HMM_PROFILE*   t_prof   = worker->t_prof;
 ...
 */
void 
WORK_load_query_by_findex_id(    WORKER*     worker,
                                 int         index_id )
{
   ARGS*          args     = worker->args;
   HMM_PROFILE*   t_prof   = worker->t_prof;
