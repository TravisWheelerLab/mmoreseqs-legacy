 ...
 *  SYNOPSIS:  Frees all data associated with VECTOR_TRACE and returns NULL pointer.
 */
VECTOR_TRACE* 
 ...
 *  SYNOPSIS:  Perform element-wise unary operation <op>(TRACE data) to each cell in <vec_in> and puts it in <vec_out>.
