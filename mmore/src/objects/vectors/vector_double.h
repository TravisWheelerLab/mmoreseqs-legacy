 ...
 *  SYNOPSIS:  Frees all data associated with VECTOR_DBL and returns NULL pointer.
 */
VECTOR_DBL* 
 ...
 *  SYNOPSIS:  Perform element-wise unary operation <op>(DBL data) to each cell in <vec_in> and puts it in <vec_out>.
