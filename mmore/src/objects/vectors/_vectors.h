/*******************************************************************************
 *  FILE:      _vectors.h
 *  PURPOSE:   Vectors of Basic Datatypes.
 *  AUTHOR:    Dave Rich
 *
 *  DESC:      Vector for each basic datatype.
 *             Promises the following API for each datatype (XXX is a template datatype):
 *                VEC_XXX*    VEC_XXX_Create( (?) ) 
 *                   - TODO: should make _Create() take a pointer arg so that it is consistent with basic types.
