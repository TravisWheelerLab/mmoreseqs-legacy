                              ...
                              BOUND*            bnd )
{
   ...
   BOUND* edg_bnd;
   edg_bnd = EDGEBOUND_ROWS_Getby_Row( edg, row_id, edg->rows_N[row_id] );
   *edg_bnd = *bnd;
   edg->rows_N[row_id]++;
                                              ...
                                              BOUND*            bnd )
{
   ...
   for ( int k = bnd->lb; k < bnd->rb; k++ ) {
      ...
      BOUND*   row      = EDGEBOUND_ROWS_Getby_Row( edg, i, row_idx - 1 );
                              ...
                              EDGEBOUNDS*       edg_out )
{
   ...
   for ( int i = 0; i < edg_in->N; i++ ) 
   {
      ...
      {
         BOUND* bnd = EDGEBOUND_ROWS_Getby_Row( edg_in, i, j );
                           ...
                           FILE*             fp )
{
   ...
   for ( int i = 0; i < edg->N; i++ )
   {
      ...
      {
         BOUND* bnd = EDGEBOUND_ROWS_Getby_Row( edg, i, j );
         fprintf(fp, "[%d] ", i);
                            ...
                            EDGEBOUND_ROWS*    edg_b )
{
   ...
   for ( int i = 0 ; i < edg_a->N; i++ ) 
   {
      ...
      {
         BOUND* bnd_a = EDGEBOUND_ROWS_Getby_Row( edg_a, i, j );
         BOUND* bnd_b = EDGEBOUND_ROWS_Getby_Row( edg_b, i, j );
